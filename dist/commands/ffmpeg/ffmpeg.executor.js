...
class FfmpegExecutor extends command_executor_1.CommandExecutor {
    ...
    prompt() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const height = yield this.promptService.input('Висота', 'number');
            const path = yield this.promptService.input('шлях до файла', 'input');
            const name = yield this.promptService.input('Імя файла', 'input');
